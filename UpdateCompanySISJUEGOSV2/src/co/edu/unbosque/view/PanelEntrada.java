...
public class PanelEntrada extends JPanel {
	...
	public static final String TOR = "Torneos";
	...
	public PanelEntrada() {
		...
		butTorneos.setBounds(165, 150, 85, 40);
		butTorneos.setActionCommand(TOR);

		butActualizarReg = new JButton("Actualizar Jugador");
		butActualizarReg.setBounds(265, 150, 140, 40);
		butActualizarReg.setActionCommand(ACT_REG);

		butEscribirReg = new JButton("Escribir Registros");
		butEscribirReg.setBounds(430, 150, 145, 40);
